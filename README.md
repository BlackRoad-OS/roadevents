...
**roadevents** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
git clone https://github.com/BlackRoad-OS/roadevents.git
cd roadevents
